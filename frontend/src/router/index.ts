...
const routes: RouteRecordRaw[] = [
  ...
  { path: '/legal/privacy', name: 'privacy', component: () => import('@/views/Legal/Privacy.vue') },
  {
    ...
    children: [
      ...
      { path: 'sector-rotation', name: 'sector-rotation', component: () => import('@/views/SectorRotation/Index.vue') },
      ...
      { path: 'strength', name: 'strength', component: () => import('@/views/StrengthScreen/Index.vue') },
