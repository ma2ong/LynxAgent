...
const alsoIncluded = [
  { title: '五方判读', body: '价值 / 趋势 / 游资 / 逆向 / 量化五个 AI 人格分别打分，看共识分与分歧度。' },
...
const faqs = [
  {
    ...
    a:
      ...
      + '每日 AI 分析有次数上限，那是算力成本所限，与之无关：名单、回放数据和复盘战绩不受任何限制。',
  },
  {
    q: '这是荐股服务吗？',
    a:
      '不是。本产品不具备证券投资咨询资质，输出的是算法对公开数据的处理结果：评分、信号、统计与 AI 生成的研究分析，' +
